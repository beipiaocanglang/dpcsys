package dpcsys.consumption.dpcInterface.listener;
...
public class DpcInterfaceAppUtil extends AppUtil {

    private static Logger logger = Logger.getLogger(DpcInterfaceAppUtil.class);
    ...
    public static void init(ServletContext in_servletContext) {
        ...
        DpcInterfaceAppUtil dpcnmmAppUtil = (DpcInterfaceAppUtil) getBean("dpcInterfaceAppUtil");
        try {
